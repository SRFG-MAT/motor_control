...
# Program for the introduction to programming with 
...
# Initialize the Lock object of threading.
lock = threading.Lock()
...
def print_all():
   ...
   # Setting the lock on the print_all() resource
   lock.acquire()
   try:
      os.system('clear')
      print "############################################"
      ...
      # Loosen the lock on the print resource
      lock.release()
